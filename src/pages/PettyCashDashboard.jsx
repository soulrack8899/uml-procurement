...
const PettyCashDashboard = () => {
  const { refreshKey, activeRole, isMobile, currentCompany } = useCompany()
  ...
  const balance = pettyCashLimit - totalSpent
  const usagePercent = Math.min(Math.round((totalSpent / pettyCashLimit) * 100), 100)
